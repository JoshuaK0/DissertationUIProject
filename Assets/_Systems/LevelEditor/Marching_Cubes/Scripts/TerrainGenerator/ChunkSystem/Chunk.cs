...
public class Chunk : MonoBehaviour
{
    ...
    public void modifyTerrain(Vector3 vertexPoint, int modification, int mat = 0)
    {
        if (modification > 0)
        {
            addTerrain(vertexPoint, mat);//A little more costly
        }
            
        else
        {
            removeTerrain(vertexPoint);//Less operations
        }
            
    }

    public void SetHeight(Vector3 vertexPoint, int height, int mat = 0)
    {
        if (vertexPoint.y <= height)
        {
    ...
    /// </summary>
    public void removeTerrain(Vector3 vertexPoint)
    {
    ...
    /// </summary>
    public void addTerrain(Vector3 vertexPoint, int mat)
    {
