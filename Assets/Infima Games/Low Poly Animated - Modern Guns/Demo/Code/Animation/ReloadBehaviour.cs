...
namespace InfimaGames.Animated.ModernGuns
{
    ...
    public class ReloadBehaviour : StateMachineBehaviour
    {
		...
		private void GetReferences()
        {
			...
			//Get Equipped Weapon.
			WeaponBehaviour weaponBehaviour = playerCharacter.GetEquippedWeapon();
			//Check Reference.
            ...
            //Get Magazine.
            magazine = weaponBehaviour.GetMagazine();
            //Get Reserve Magazine.
            magazineReserve = weaponBehaviour.GetMagazineReserve();
        }
